...
const MainLayout: React.FC = () => {
    ...
    // Map routes to titles (can be improved with a proper route config later)
    ...
    return (
        <div className="flex h-screen bg-background text-text-primary font-sans relative overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden z-10 relative">
                ...
                <div className={`flex-1 flex flex-col min-w-0 ${isFullScreenView ? 'overflow-hidden' : 'overflow-y-auto overflow-x-hidden'}`}>
